			  ...
			  <div class="postcontent">
			    <form id="form1" name="form1" method="post" action="insertupdate">
			      <table width="445" height="536" border="0">
                    <tr>
                      <td><div align="right" class="style7 style1"><strong>About me </strong></div></td>
                      <td><div align="left">
                          <textarea name="aboutme">About me Section</textarea>
                      </div></td>
                    </tr>
                      <tr>
                      <td><div align="right" class="style7 style1"><strong>Sports</strong></div></td>
                      <td><div align="left">
                          <textarea name="sports">Sports Section</textarea>
                      </div></td>
                    </tr>
					  <tr>
                      <td><div align="right" class="style7 style1"><strong>Favorite Actress </strong></div></td>
                      <td><div align="left">
                          <textarea name="favactress">Favorite Actress</textarea>
                      </div></td>
                    </tr>
                    <tr>
