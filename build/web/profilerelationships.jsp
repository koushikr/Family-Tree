				...
				<div class="menucontent">
				  ...
				  <ul>
				    <li><a href="profilemybasics.jsp">MY BASICS </a></li>
					  ...
					  <li><a href="profilerelationship.jsp">relationships</a></li>
				  </ul>
			  </div>
			  ...
			  <div class="postcontent">
			    <form id="form1" name="form1" method="post" action="insertupdate">
			      <table width="445" height="536" border="0">
                   <tr>
                      <strong>List of Your relationships would appear here..</strong>
					  <a href="realtionship.html">Enter a relationship here</a>
                    </tr>
                    <tr>
