			  ...
			  <div class="postcontent">
			    <form id="form1" name="form1" method="post" action="insertupdate">
			      <table width="445" height="536" border="0">
                    <tr>
                      <th width="170" scope="col"><div align="right" class="style7 style1"><strong>Primary Email</strong></div></th>
                      <th width="265" scope="col"> <div align="left">
                          <input name="contactno" type="text" value="Primary Email Address" />
                      </div></th>
                    </tr>
					<tr>
                      <th width="170" scope="col"><div align="right" class="style7 style1"><strong>Secondary Email</strong></div></th>
                      <th width="265" scope="col"> <div align="left">
                          <input name="contactno" type="text" value="Secondary Email Address" />
                      </div></th>
                    </tr>
					<tr>
                      <th width="170" scope="col"><div align="right" class="style7 style1"><strong>Yahoo IM</strong></div></th>
                      <th width="265" scope="col"> <div align="left">
                          <input name="contactno" type="text" value="Yahoo IM" />
                      </div></th>
                    </tr>
					<tr>
                      <th width="170" scope="col"><div align="right" class="style7 style1"><strong>Gmail</strong></div></th>
                      <th width="265" scope="col"> <div align="left">
                          <input name="contactno" type="text" value="Gmail" />
                      </div></th>
                    </tr>
					<tr>
                      <th width="170" scope="col"><div align="right" class="style7 style1"><strong>Mobile Number</strong></div></th>
                      <th width="265" scope="col"> <div align="left">
                          <input name="contactno" type="text" value="Mobile Number" />
                      </div></th>
                    </tr>
					<tr>
                      <th width="170" scope="col"><div align="right" class="style7 style1"><strong>Land Line</strong></div></th>
                      <th width="265" scope="col"> <div align="left">
                          <input name="contactno" type="text" value="LandLine" />
                      </div></th>
                    </tr>
                    <tr>
